...
bool Phyber::EventBackend::SDL::poll_event(Phyber::Event &event) {
    SDL_Event sdl_event;
...
const char *Phyber::EventBackend::SDL::get_key_name_from_virtual_key(const Phyber::KeyboardEvent::KeySymbol::VirtualKey &virtual_key) {
